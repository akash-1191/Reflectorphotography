...
<!-- add inside bode tag class=" overflow-hidden" -->

<body>
    <div id="preloader"
        class=" scroll m-0 font-serif flex items-center justify-center h-screen sm:h-screen  w-[100%]  none bg-fixed top-0 left-0  z-10  ">
        <img src="https://www.taj.studio/wp-content/themes/dec2016/images/website_preloader.gif" alt="Photography GIF"
            class="w-[10%] h-[15%] rounded-lg bg-fixed">
    </div>
    </div>
    </div>
    ...
    include_once("corocel.php");
    ?>

    <!-- awards strat -->
    <div class="flex  justify-center sm:m-0" style="background-color: rgb(245, 242, 237);">
        <img src="./image/awards.jpg" class=" w-auto " alt="awards">
    </div>
    <!-- awards end -->

    <!-- content of the Weding section-->
    <section>
    ...
    <section class="">
        <div class="  w-full h-full lg:p-20  md:p-0 sm:p-0">
            <div id="wrap"
    ...
    <!-- content of the newborn section -->
    <section>
        <div class="h-full w-full ">
            <div
    ...
    <section>
        <div class="w-full h-full lg:p-20  md:p-0 sm:p-0">
            ...
            <div id="wrap" class="grid lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-2 gap-x-2 max-w-[100%] lg:py-4 p-4 w-[82%] gap-3 m-auto">

                <iframe class=" sm:w-56 h-52 lg:w-full lg:h-[350px] md:w-full md:h-52"
                    src="https://www.youtube.com/embed/7pVpquui3Rc?si=RRCFWTBKAOx5Lmhm" title="YouTube video player"
                    frameborder="0"
                ...
                <iframe class=" sm:w-56 h-52 lg:w-full lg:h-[350px] md:w-full md:h-52"
                    src="https://www.youtube.com/embed/ZpeFEBMRCyM?si=DrXxzMNHrpQRwqDK" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
                ...
                <iframe class=" sm:w-56 h-52 lg:w-full lg:h-[350px] md:w-full md:h-52"
                    src="https://www.youtube.com/embed/hqKzh96GokU?si=4yrWOeGrtyjgCC2_" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
                ...
                <iframe class=" sm:w-56 h-52 lg:w-full lg:h-[350px] md:w-full md:h-52"
                    src="https://www.youtube.com/embed/81gSu_kmR4Q?si=CCKR6S-f7laZykDw" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
                ...
                <iframe class=" sm:w-56 h-52 lg:w-full lg:h-[350px] md:w-full md:h-52"
                    src="https://www.youtube.com/embed/Rf9flQISwok?si=R6cwUJvvyjCcuhV-" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>

                <iframe class=" sm:w-56 h-52 lg:w-full lg:h-[350px] md:w-full md:h-52"
                    src="https://www.youtube.com/embed/LC2cFkSoe6g?si=FWkZblMr95thGIUA" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
            </div>
